...
class encoder_singleVectorOutput(object):
    def __init__(self, outputVectorDim, nameScope='encoder_singleVectorOutput', trainable=True, bnPhase=True, reuse=False, coreActivation=tf.nn.leaky_relu, lastLayerActivation=None):
...
class encoder_gridOutput(object):
    def __init__(self, lastLayserChannelNum, nameScope='encoder_gridOutput', trainable=True, bnPhase=True, reuse=False, coreActivation=tf.nn.leaky_relu, lastLayerActivation=None):
